...
async function listNotificationsForUser(userId, limit = 30, options = {}) {
  await ensureSchema();

  const safeLimit = Math.max(1, Math.min(300, Number.parseInt(String(limit), 10) || 30));
